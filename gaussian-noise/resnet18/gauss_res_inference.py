...
def main():
    test_real_dir = '/scratch/am13018/real_vs_fake/real-vs-fake/test/real/'
    test_real_path = os.listdir(test_real_dir)
    test_fake_dir = '/scratch/am13018/real_vs_fake/real-vs-fake/test/fake/'
    ...
    # image_transforms = {'validation_transform': A.Compose([A.Resize(image_size, image_size),
    ...
    checkpoint_filepath='/scratch/am13018/gauss_checkpoints/realresnet/RGbest_model_22.pth'
